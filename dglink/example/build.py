...
def get_ctf_ucf():
    ...
    node_entries = [
        ...
        for name, nsid in entries.items() if nsid is not None
    ]
    relations = [
...
def get_nf_ac_crispr():
    df = pandas.read_excel('NF2-_AC-CRISPR-A19 drug treatment.xlsx', sheet_name='Sheet1',
                           skiprows=1)
...
if __name__ == '__main__':
    ...
    relations = [[':START_ID', ':END_ID', ':TYPE']] + relations1 + relations2 + relations3
